  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="resources/images/images.jpg" alt="musical_instruments" width="460" height="345">
      </div>

      <div class="item">
        <img src="resources/images/images1.jpg" alt="musical_instruments" width="460" height="345">
      </div>
    
      <div class="item">
        <img src="resources/images/images3.jpg" alt="musical_instruments" width="460" height="345">
      </div>
...
<table class="table" style="height: 60%; width: 120%">
   <tr>
   <td>
   <img src="images1.jpg" class="img-responsive img-circle" alt="Music Image">
   <a href="product" >
        <h4>Piano</h4></a>
  </td>
   <td>
   ...
   <td>
   <img src="resources/images/images.jpg" class="img-responsive img-circle" alt="Music Image">
   <a href="product" >
        <h4>Musical Accessories</h4></a></td>
   </tr>
